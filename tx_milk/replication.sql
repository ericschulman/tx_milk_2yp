WITH outcomes as (select COUNTY, SYSTEM, VENDOR, WIN is not '' as WIN from raw),

sum_wins as (select COUNTY, SYSTEM, sum(WIN) as SUM_WINS from outcomes group by SYSTEM),
