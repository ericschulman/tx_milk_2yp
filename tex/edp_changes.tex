...
%include table with this regression (reg 10) just previous volume

%include table with delta vol

%include regf1?

%include a model without previous weeks vol linear

%include a model without previous weeks with CTA
