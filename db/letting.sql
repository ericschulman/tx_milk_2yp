...
SUM(CASE WHEN (WW<.15) THEN 1 ELSE 0 END) as LOW_BIDS,
SUM(CASE WHEN (WW<.15 and MONTH = 5) THEN 1 ELSE 0 END) as MAY,
SUM(CASE WHEN (WW<.15 and MONTH = 6) THEN 1 ELSE 0 END) as JUNE,
SUM(CASE WHEN (WW<.15 and MONTH = 7) THEN 1 ELSE 0 END) as JULY,
SUM(CASE WHEN (WW<.15 and MONTH = 8) THEN 1 ELSE 0 END) as AUG
FROM milk
WHERE WIN  = 1
AND FMOZONE = 1
AND YEAR >= 1980 AND YEAR <= 1991
